(() => {
    ...
    function menuInit() {
        if (window.innerWidth <= 991) document.querySelector(".menu__body").classList.add("hidden");
        if (window.innerWidth > 991) document.querySelector(".menu__body").classList.remove("hidden");
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("menu-open");
                document.querySelector(".menu__body").classList.toggle("hidden");
            }
        }));
    }
    function menuClose() {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery__swiper")) new core(".gallery__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
